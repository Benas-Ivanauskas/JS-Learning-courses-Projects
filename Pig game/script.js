...
const score1El = document.getElementById('score--1'); // working same as querySelector
...
const btnHodl = document.querySelector('.btn--hold');
...
btnRoll.addEventListener('click', function () {
  if (playing) {
    ...
    diceEl.src = `dice-${dice}.png`; // allows to add src png

    //3. Check for rolled1: if true, switch next player
    if (dice !== 1) {
